...
class EpisodiosBCS extends Component {
      ...
      async componentDidUpdate(prevProps, prevState) {
        if (prevState.episodeSelectedId != this.state.episodeSelectedId) {
          const Apirequest = "https://tarea-1-breaking-bad.herokuapp.com/api/episodes/"+this.state.episodeSelectedId+"?series=Better+Call+Saul"
                ...
                <div className="card text-white bg-secondary mb-3 w-50">
                  ...
                  <div className="card-body-episodeInfo">
                    ...
                    <div className="card-text">
                      ...
                      <li>
                        <Link id={chr} 
                        className="text-white" to={`/better-call-saul/episodes/character/${chr}`} 
